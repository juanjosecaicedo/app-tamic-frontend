  ...
  <div class="wrapper">
    <div class="animated fadeIn">
              ...
              <template slot="actions" slot-scope="data">
                <b-button-group size="sm">
                  ...
                  <b-button v-b-tooltip.hover title="Eliminar" variant="danger" size="sm"
                    @click="fnt_delete_roles(data.item.role_id)">
                    <i class="fa fa-trash" />
                  </b-button>
                </b-button-group>
              </template>
      ...
      <b-modal :id="modal.id" :title="modal.title" @hide="fnt_clear_modal">
        <form ref="form" @submit.stop.prevent="fnt_update_roles">
          <b-form-group label="Nombre">
            <b-form-input type="text" v-model="name" required></b-form-input>
          </b-form-group>
        </form>
        <template v-slot:modal-footer>
          <b-button variant="primary" class="float-right" @click="fnt_update_roles">Guardar</b-button>
        </template>
      </b-modal>
    </div>
  </div>
  ...
  export default {
    ...
    methods: {
      ...
      fnt_send_data(item, index, button) {
        this.modal.title = "Rol";
        this.modal.content = item;
        this.name = this.modal.content.name;
        this.role_id = this.modal.content.role_id;

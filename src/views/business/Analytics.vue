      ...
      <b-col md="12">
        <b-card header="Tráfico &amp; Ventas">
          <b-row>
            <b-col sm="12" lg="6">
              ...
              <div class="chart-wrapper">
                <card-bar chartId="chart-bar-01" :first_data="array_recurrent_users" :second_data="array_new_users"
            ...
            <b-col sm="12" lg="6">
              ...
              <div class="chart-wrapper mb-5">
                <card-doughnut chartId="chart-doughnut-01" :data="data_gender" :labels="labels_gender"
                  v-if="loaded_gender && data_gender.length" :height="150" />
              </div>
              <div class="chart-wrapper">
                <card-doughnut chartId="chart-doughnut-01" :data="data_count_categories"
                  :labels="labels_count_categories" v-if="loaded_count_categories && data_count_categories.length"
                  :height="150" />
              </div>
            </b-col>
          </b-row>
          ...
          <b-row>
            <b-col>
              <div slot="header">
                <div class="card-header-actions" v-if="items != null || items != undefined">
